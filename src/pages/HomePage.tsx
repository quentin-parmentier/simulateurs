...
const simulators = [
  {
    ...
    path: '/immobilier',
    icon: Building2,
    title: 'Rentabilité Immobilière V2',
    description: "Simulateur complet : rendement brut/net, cash-flow, fiscalité LMNP/nue propriété, amortissements et projection sur la durée du crédit.",
    badge: 'V2',
